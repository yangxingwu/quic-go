...
// SetLowerLimit mocks base method
func (_m *MockReceivedPacketHandler) SetLowerLimit(_param0 protocol.PacketNumber) {
	_m.ctrl.Call(_m, "SetLowerLimit", _param0)
}

// SetLowerLimit indicates an expected call of SetLowerLimit
func (_mr *MockReceivedPacketHandlerMockRecorder) SetLowerLimit(arg0 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCallWithMethodType(_mr.mock, "SetLowerLimit", reflect.TypeOf((*MockReceivedPacketHandler)(nil).SetLowerLimit), arg0)
}
